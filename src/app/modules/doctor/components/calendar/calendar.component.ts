  ...
  constructor(private datePipe: DatePipe) {
    this.calendarOptions = {
      ...
      events: [
        ...
        { title: 'Surgery', start: '2024-12-21', end: '2024-12-22', description: 'Operation' },
      ],
  ...
  updateViewTitle(): void {
    ...
    if (calendarApi) {
      ...
      if (view.type === 'dayGridMonth') {
        this.currentViewTitle = 'Month View: ' + this.datePipe.transform(view.currentStart, 'MMMM y');
        ...
        this.currentViewTitle = 'Day View: ' + this.datePipe.transform(view.currentStart, 'fullDate');
      } else {
